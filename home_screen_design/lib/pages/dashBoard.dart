...
import 'package:home_screen_design/pages/my_flutter_app_icons.dart' as CustomIcons;
...
//Junta y construye todo el contenido
  Widget _buildContent(){
    return StaggeredGridView.count(
      ...
      children: <Widget>[
        Container(),
        myItems(CustomIcons.MyFlutterApp.money, 'Movimientos en bolsa', Colors.blue[900]),
          ...
          child: Stack(
            ...
            children: <Widget>[
              Container(
                ...
                child: _buildText('Bienvenido a Servicios Generales Bursatiles', Colors.white),
              ),
              _buildContent(),
            ],
          ),
